...
local function v0_55(...) pcall(function(...)
        if writefile and(v0_8 and h)then
            local v61_1={[ "selectedZones" ]=h.selectedZones or{};
...
local v0_56=v0_54()h={[ "godmode" ]= true ,[ "autoGlide" ]= true ,[ "autoHatch" ]= true ;
...
v0_61=function(v90_1,...)
    if not v90_1 and not((h.pureTweenFarm or h.autoFarmLoop or h.teleporting ))then
        return
    end
        ...
        if v191_1 and(v191_2 and v191_2.Records )then
            for v193_1,v193_2 in ipairs(v191_2.Records )do
                if v193_2.Uid ==v188_2 and v193_2.AreaId then
                    return v0_39[v193_2.AreaId ]or h.glideSpeed or 350
                end
            end
        end
    end
    ...
    local v203_1 v203_1=hookmetamethod(game, "__newindex" ,v0_14(function(v204_1,v204_2,v204_3,...)
        if not v0_13()and typeof(v204_1)== "Instance" then
            ...
            if v204_1:IsA( "Humanoid" )then
                ...
                if v204_2== "Sit" and(v204_3== true and((h.pureTweenFarm or h.autoFarmLoop or h.isReturning or h.glidingToTarget )))then
                    return nil
                end
            end
        end
...
v0_98=function(v227_1,...)
    ...
    v227_1.DescendantAdded :Connect(function(v233_1,...)
        ...
        if v238_1:IsA( "Tool" )and(((h.pureTweenFarm or h.autoFarmLoop ))and not h.holdingEggForGuard )then
        ...
        if v297_1 then
            ...
            for v300_1,v300_2 in ipairs(v297_1:GetChildren())do
                ...
                if v300_4 and v300_4:IsA( "BasePart" )then
                    if v300_3 and(h and h.autoTreadmill )then
...
v0_88()v0_2.DescendantAdded :Connect(function(v309_1,...) pcall(function(...)
...
)v0_85=function(...) h.onTreadmill = false h.teleporting = false h.glidingToTarget = false h.securingEgg = false h.isReturning = false h.delivering = false h.holdingEggForGuard = false h.currentTargetModel =nil h.targetPosition =nil h.stateTime =os.clock ()
    ...
    pcall(function(...)
        ...
        if v0_61 and((h.pureTweenFarm or h.autoFarmLoop ))then
            v0_61()
        end
    end
    )
...
v0_94=function(v345_1,...) h.godmode =v345_1
...
v0_69=function(...)
    ...
    h.plot =v361_5 h.plotVerified =v361_6 h.origin =v361_5:FindFirstChild( "CenterPoint" )
    local v361_7=v361_5:FindFirstChild( "ToUpdate" )h.pen =(v361_7 and v361_7:FindFirstChild( "PetArea" ))or v361_5:FindFirstChild( "PetArea" )h.tread =v361_5:FindFirstChild( "TreadmillBottom" )
    if not h.pen and v361_7 then
    ...
    if not h.origin then
        h.origin =v361_5:FindFirstChild( "CenterPoint" )or h.pen or v361_5.PrimaryPart
    end
    if not h.pen then
        h.pen =h.origin
    end
    ...
    for v430_1,v430_2 in ipairs(v410_6)do
        ...
        if v430_4 then
            ...
            if v432_2 and v432_3~= false then
                v410_4=v410_4+ 1 v410_5[#v410_5+ 1 ]=v430_4.Position Log(string.format ( "[PlaceEgg] Placed egg %s from inventory" ,tostring(v430_3)))
            end
            task.wait ( 0.04 )
        end
    end
...
v0_73=function(v435_1,...)
    if(not v435_1 and not h.autoHatch )or not v0_27 or not v0_28 or not v0_23 then
        return 0
    end
    ...
    Log(string.format ( "[AutoHatch] Found %d eggs ready to hatch! Starting hatch sequence..." ,#v435_5))h.statusText =string.format ( "[Hatch] Hatching %d ready eggs..." ,#v435_5)
    local v435_7= 0
        ...
        task.spawn (function(...)
            ...
            if v454_1 and v454_2~= false then
                ...
                if v458_1 and v458_2~= false then
                    v435_7=v435_7+ 1 h.hatched =((h.hatched or 0 ))+ 1 Log(string.format ( "[+] [AutoHatch] Hatched %s (UID: %s) -> Total Hatched: %d" ,v453_2.category ,tostring(v453_2.uid ),h.hatched ))
                end
            end
        end
        )task.wait ( 0.04 )
    end
    task.wait ( 0.95 )h.isHatching = false Log(string.format ( "[AutoHatch] Finished! Hatched %d eggs." ,v435_7))
    return v435_7
end
v0_77=function(...)
    local v463_1={}
...
v0_79=function(v470_1,v470_2,v470_3,...)
    ...
    local v470_7=v0_70()v470_1=math.max ( 100 ,v470_1 or h.glideSpeed or 600 )
    local v470_8=h.laneZ or v0_40 h.isReturning = true h.stateTime =os.clock ()v0_67(v470_7, 20 )v470_5.AssemblyLinearVelocity =Vector3.zero v470_5.AssemblyAngularVelocity =Vector3.zero
    local v470_9=v0_66()
    local v470_10=math.max (v470_1,v470_9)
    local v470_11=os.clock ()+ 25
    while h.alive and(h.isReturning and os.clock ()<v470_11)do
        ...
        if not v470_3 and(not h.pureTweenFarm and not h.autoFarmLoop )then
            if v470_6 then
                v470_6.AutoRotate = true
            end
            h.isReturning = false
        ...
        if v473_16 then
            h.statusText =string.format ( "Tweening Home (Z: %.0f) [DODGING TRAP!]" ,v473_14)
        else
            h.statusText =string.format ( "Tweening Home (%.0f studs | Z: %.0f | Spd: %.0f)" ,v473_2,v473_14,v473_4)
        end
    end
    ...
    v0_61()h.isReturning = false h.delivering = false h.statusText = "Arrived at Base PetArea!"
    return true
end
v0_76=function(v489_1,v489_2,v489_3,...)
    ...
    if v489_8> 8 then
        h.statusText = "[Place] Tweening back to base plot..." v0_79(v489_1 or h.glideSpeed or 600 ,v489_2, true )
    end
    v0_67(v489_7, 15 )v489_5.CFrame =CFrame.new (v489_7)v489_5.AssemblyLinearVelocity =Vector3.zero h.statusText = "[Place] Placing All Eggs to Stand..."
    local v489_9=os.clock ()+ 3
    while v0_60()> 0 and(os.clock ()<v489_9 and h.alive )do
        v0_72()task.wait ( 0.06 )
    end
    h.statusText = "[Place] Hatching ready eggs..." v0_73( true )v0_61()h.isReturning = false h.delivering = false h.currentTargetModel =nil h.targetPosition =nil
    local v489_10=v0_60()h.statusText =string.format ( "Placed & Hatched (Left: %d)! Hands Free." ,v489_10)
end
local v0_115= 5 v0_74=function(v493_1,...)
    if h.isBatchPlacing then
        return
    end
    h.isBatchPlacing = true Log(string.format ( "[AutoPlace] %d steals done! Batch placing (%s mode)..." ,v0_115,tostring(v493_1)))
    local v493_2=v0_104 h.pureTweenFarm =(v493_1== "TWEEN" )h.autoFarmLoop =(v493_1== "WARP" )
    ...
    if v493_7> 8 then
        h.statusText = "[AutoPlace] Tweening home to base plot..." v0_79(h.glideSpeed or 600 ,v493_2, true )
    end
    if v493_4 then
    ...
    )v0_61()h.isReturning = false h.delivering = false h.glidingToTarget = false h.securingEgg = false h.teleporting = false h.currentTargetModel =nil h.targetPosition =nil
    for v499_1= 5 , 1 , -1 do
        if not h.alive then
            break
        end
        h.statusText =string.format ( "[AutoPlace] At Base: Resuming in %ds..." ,v499_1)task.wait ( 1 )
    end
    h.isBatchPlacing = false
    if h.alive and v0_104==v493_2 then
        Log(string.format ( "[AutoPlace] Done! Continuing %s farm." ,v493_1))h.statusText =string.format ( "[AutoPlace] Resuming %s farm..." ,v493_1)
...
v0_75=function(v504_1,...)
    ...
    h.batchStealCount =((h.batchStealCount or 0 ))+ 1 Log(string.format ( "[AutoPlace] Steal trip %d / %d completed successfully." ,h.batchStealCount ,v0_115))
    if h.batchStealCount >=v0_115 then
        h.batchStealCount = 0 task.spawn (function(...) v0_74(v504_1)
        end
        )
        return true
    end
...
local function v0_116(v508_1,v508_2,v508_3,v508_4,...)
    ...
    v508_2=math.max ( 60 ,v508_2 or h.glideSpeed or 350 )
    ...
    local v508_9=h.laneZ or v0_40 h.glidingToTarget = true h.stateTime =os.clock ()
    local v508_10= 0
    local v508_11=os.clock ()+ 15
    while h.alive and(h.glidingToTarget and os.clock ()<v508_11)do
        ...
        if v512_18 then
            h.statusText =string.format ( "Gliding Out (Z: %.0f) [DODGING TRAP!]" ,v512_17)
        else
            h.statusText =string.format ( "Gliding -> Egg (%.0f studs | H: %.0f)" ,v512_2,v512_3)
        end
    end
...
v0_78=function(v529_1,v529_2,v529_3,v529_4,...)
    ...
    if v529_6 then
        ...
        if v530_1<= 535 and v530_2> 510 then
            ...
            if v531_2> 5 then
                h.statusText = "[AutoSteal] Exiting Base -> Waypoint (500, 70, -364)..." Log(string.format ( "[AutoSteal] Leaving base (X=%.1f): Gliding to waypoint (500, 70, -364) first (dist=%.1f studs)..." ,v530_1,v531_2))
...
v0_80=function(v534_1,v534_2,...)
    ...
    local v534_6=h.laneZ or v0_40
    local v534_7=Vector3.new (v0_41- 10 , 70 ,v534_6)v534_1=math.max ( 100 ,v534_1 or h.glideSpeed or 350 )h.isReturning = true h.stateTime =os.clock ()v0_67(Vector3.new (v0_41, 70 ,v534_6), 20 )pcall(v0_61)v534_4.AssemblyLinearVelocity =Vector3.zero v534_4.AssemblyAngularVelocity =Vector3.zero
    local v534_8=v0_66()
    local v534_9=math.max (v534_1,v534_8)
    local v534_10=os.clock ()+ 15
    while h.alive and(h.isReturning and os.clock ()<v534_10)do
        ...
        if v537_15 then
            h.statusText =string.format ( "Tweening Safe Line (Z: %.0f) [DODGING!]" ,v537_13)
        else
            h.statusText =string.format ( "Tweening to Safe Line (%.0f studs | X: %.0f)" ,v537_2,v537_1.X )
        end
    end
    ...
    v0_61()h.isReturning = false h.delivering = false
    if h then
        h.onTreadmill = false
    end
        ...
        if v573_1 then
            ...
            for v575_1,v575_2 in ipairs(v573_1:GetChildren())do
                ...
                if v575_3 then
                    ...
                    if v576_1 then
                        h.plot =v575_2 h.plotVerified = true v570_2=v575_3
                        break
                    end
                end
            end
...
v0_89=function(v582_1,...)
    ...
    if v582_3.Position.X > 535 then
        h.statusText = "[AutoTreadmill] Returning along highway to base..." v0_80(h.glideSpeed ,v582_1)
        if v582_1 and v0_104~=v582_1 then
            return false
        end
        if v582_3.Position.X > 535 then
            if v582_3.Position.X <= 560 then
                v582_3.CFrame =CFrame.new (v0_41, 70 ,h.laneZ or v0_40)
            else
                return false
            end
        end
    ...
    if v582_8> 4 then
        ...
        local v603_1=math.max ( 250 ,h.glideSpeed or 400 )
        local v603_2=os.clock ()
        while h.alive and(((Vector2.new (v582_3.Position.X ,v582_3.Position.Z )-Vector2.new (v582_7.X ,v582_7.Z ))).Magnitude > 4 and(os.clock ()-v603_2< 4 ))do
            if v582_1 and v0_104~=v582_1 then
                return false
            end
    ...
    while h.alive and(math.abs (v582_3.Position.Y -v582_7.Y )> 2 and(os.clock ()-v582_9< 1.5 ))do
        if v582_1 and v0_104~=v582_1 then
            return false
        end
    ...
    if v582_10<= 6 then
        ...
        h.onTreadmill = false v0_17(string.format ( "[AutoTreadmill] Not yet at treadmill pad (dist=%.1f studs). Will retry!" ,v582_10))
        return false
    end
end
...
local function v0_122(...)
    local v672_1=h.plot or(v0_69 and v0_69())
    if not v672_1 then
        return nil
    end
...
local function v0_125(...)
    ...
    local v680_1=h.plot or(v0_69 and v0_69())
    if not v680_1 then
        return
    end
    ...
    local function v845_7(v888_1,v888_2,...)
        ...
        for v889_1,v889_2 in ipairs(v845_1)do
            ...
            if v889_3 and(not v889_4 and(((v888_2 or not v889_5))and v889_2.BoundsCFrame ))then
                ...
                local v890_14=(h.selectedZones and h.selectedZones [v890_10]== true )
                local v890_15=(h.selectedRarities and h.selectedRarities [v890_12]== true )
                local v890_16= false
                if v890_13 then
                    v890_16= true
                else
        ...
        if#v888_6> 0 then
            Log( "[AutoSteal v42.44] " ..table.concat (v888_6, " | " ))
        end
        return v888_5
    end
...
v0_83=function(v923_1,v923_2,v923_3,v923_4,...)
    ...
    local v923_8=v923_2.Position v0_67(v923_8, 14 )h.currentTargetModel =v923_3 h.targetPosition =v923_8 v923_6.AssemblyLinearVelocity =Vector3.zero v923_6.AssemblyAngularVelocity =Vector3.zero v0_97(v923_5)pcall(function(...) v0_10:RequestStreamAroundAsync(v923_8)
    end
    )
    if not v923_3 and v0_2:FindFirstChild( "AreaEggSlotsClient" )then
        for v927_1,v927_2 in ipairs(v0_2.AreaEggSlotsClient :GetChildren())do
            ...
            if v927_3 and((v927_3.Position -v923_8)).Magnitude <= 16 then
                v923_3=v927_2 h.currentTargetModel =v927_2
                break
            end
        end
    end
    ...
    h.statusText = "[1/4] Lifting Egg to Trigger Guard..." Log(string.format ( "[GuardStrike] Step 1: Lifting target egg (%s)..." ,tostring(v923_1)))
    local v923_9=os.clock ()+ 3.5
    local v923_10= 0
    while not v0_62()and(os.clock ()<v923_9 and(h.alive and h.securingEgg ))do
    ...
    local v923_13= false
    while v0_62()and(os.clock ()<v923_12 and(h.alive and h.securingEgg ))do
        if v923_4 and v0_104~=v923_4 then
    ...
    while not v0_62()and(os.clock ()<v923_14 and(h.alive and h.securingEgg ))do
        if v923_4 and v0_104~=v923_4 then
    ...
    if v923_15 then
        pcall(v0_61)Log( "[GuardStrike] Egg successfully secured after guard strike! Stashed in backpack." )h.statusText = "Egg Secured! Tweening along Z=-360..."
    else
        v0_17( "[-] Failed to re-grab egg after guard strike (stolen or despawned)" )h.statusText = "[-] Failed to re-grab egg"
        if v923_1 then
            v0_100[v923_1]=os.clock ()+ 2
        end
    end
...
v0_84=function(v966_1,v966_2,...)
    ...
    if v966_7 then
        ...
        if not v973_1 and v973_2~= "CarriedBySelf" then
            v0_17(string.format ( "[Snipe] Target egg %s is already taken (%s)! Selecting next target..." ,tostring(v966_7),tostring(v973_2)))h.statusText = "Target taken by another player!" v0_100[v966_7]=os.clock ()+ 5 v0_85()
            return false
        end
    end
    ...
    if not v966_9 then
        local v975_1=v0_81()
        if not v975_1 then
            v0_17( "[-] Lake egg not found" )h.statusText = "[-] No Lake egg found" v0_85()
            return false
        end
        h.currentTargetModel =v975_1.Model h.targetPosition =v975_1.Position
        ...
        if v975_2> 60 then
            h.statusText =string.format ( "[2/7] Gliding to Lake Egg (%.0f studs)..." ,v975_2)h.glidingToTarget = true
            local v978_1=v0_78(v975_3,h.glideSpeed ,v975_1.Uid ,v966_2)h.glidingToTarget = false
            if not v978_1 then
                v0_17( "[-] Lake starter egg was taken during flight" )v0_100[v975_1.Uid ]=os.clock ()+ 5 v0_85()
                return false
            end
        else
            h.statusText = "[2/7] Aligning with Lake Egg..." v966_4.CFrame =v975_3 v966_4.AssemblyLinearVelocity =Vector3.zero task.wait ( 0.04 )
        end
        v966_4.Anchored = true task.wait ( 0.06 )v966_4.Anchored = false h.holdingEggForGuard = true
        local v975_4=os.clock ()+ 3
        while not v0_62()and(os.clock ()<v975_4 and(h.alive and h.teleporting ))do
        ...
        if not v0_62()then
            v0_17( "[-] Lake egg pickup failed" )h.statusText = "[-] Lake pickup failed" v0_85()
            return false
        end
    end
    h.statusText = "[3/7] Pre-streaming Target..." pcall(function(...) v0_10:RequestStreamAroundAsync(v966_8)
    end
    )v0_67(v966_8, 12 )h.statusText = "[4/7] Waiting for physical bounce..." v966_4.Anchored = false v966_5:ChangeState(Enum.HumanoidStateType.Running )
    ...
    h.holdingEggForGuard = true v0_68(v966_13)
    local v966_16=os.clock ()
    local v966_17= false
    local v966_18=os.clock ()+ 2.5
    local v966_19= false
    while os.clock ()<v966_18 and(h.alive and h.teleporting )do
        if v966_2 and v0_104~=v966_2 then
    ...
    v966_5.WalkSpeed =v966_10 h.holdingEggForGuard = false
    if not v966_17 then
        v0_17( "[-] No bounce detected, aborting" )h.statusText = "[-] Aborted (No bounce detected)" v0_85()pcall(v0_61)
        return false
    end
    task.wait ( 0.05 )
    if v966_7 then
        ...
        if not v1002_1 and v1002_2== "CarriedByOther" then
            v0_17(string.format ( "[Snipe] Target egg %s was snatched while bouncing (%s)! Aborting warp..." ,tostring(v966_7),tostring(v1002_2)))h.statusText = "Target taken! Aborting warp..." v0_100[v966_7]=os.clock ()+ 5 v0_85()
            return false
        end
    end
    h.currentTargetModel =v966_1 and v966_1.Model h.targetPosition =v966_8 h.statusText = "[5/7] Warping to Target Egg..." v0_67(v966_8, 8 )v966_3:PivotTo(v966_6*CFrame.new ( 0 , 0.4 , 0 ))v966_4.Anchored = true
    ...
    if not v966_21 then
        v0_17( "[-] Guard Strike criteria not met" )h.statusText = "[-] Guard Strike criteria failed" v0_85()
        return false
    else
        h.statusText = "[7/7] Target Secured! Stashing into Backpack..." h.teleporting = false pcall(v0_61)
        return true
    end
end
v0_106=function(v1015_1,...)
    ...
    v0_104=v0_104+ 1
    local v1015_2=v0_104 v0_105= "SWITCHING" h.pureTweenFarm = false h.autoFarmLoop = false pcall(v0_85)pcall(v0_61)
    ...
    task.delay ( 0.06 ,function(...)
        if v0_104==v1015_2 then
            v0_105=v1015_1
            if v1015_1== "TWEEN" then
                h.pureTweenFarm = true h.autoFarmLoop = false pcall(v0_61)Log( "[FarmController] Pure Auto Steal (Tween) ACTIVATED exclusively." )
            elseif v1015_1== "WARP" then
                h.autoFarmLoop = true h.pureTweenFarm = false pcall(v0_61)Log( "[FarmController] Snipe Auto Loop (Warp) ACTIVATED exclusively." )
            else
...
local v0_140=os.clock ()task.spawn (function(...)
    while h.alive do
        local v1033_1,v1033_2=pcall(function(...)
            if h.pureTweenFarm and(not h.autoFarmLoop and(v0_105== "TWEEN" and(not h.isBatchPlacing and(not h.teleporting and(not h.glidingToTarget and(not h.securingEgg and(not h.delivering and not h.isReturning )))))))then
                ...
                if v1035_2 and v1035_3 then
                    ...
                    if not v1036_1 then
                        ...
                        local v1037_2=v0_82()
                        if v1037_2 and(h.pureTweenFarm and(v0_105== "TWEEN" and v0_104==v1037_1))then
                            if h.onTreadmill or v0_92()then
                                h.statusText = "[AutoSteal] Target found! Getting off treadmill..." v0_90()task.wait ( 0.08 )
                            end
                            local v1038_1,v1038_2=v0_64(v1037_2.Uid )
                            if not v1038_1 and v1038_2~= "CarriedBySelf" then
                                Log(string.format ( "[AutoSteal] Egg %s already taken (%s). Switching to next target..." ,tostring(v1037_2.Uid ),tostring(v1038_2)))v0_100[v1037_2.Uid ]=os.clock ()+ 5 task.wait ( 0.12 )
                                return
                            end
                            h.currentTargetModel =v1037_2.Model h.targetPosition =v1037_2.Position h.glidingToTarget = true h.stateTime =os.clock ()
                            local v1038_3=((v1037_2.Scale and v1037_2.Scale > 1.05 ))and string.format ( " | %.1fx" ,v1037_2.Scale )or "" h.statusText =string.format ( "[AutoSteal] Flying to %s (%s%s)..." ,tostring(v1037_2.Category or "Egg" ),tostring(v1037_2.Area or "Field" ),v1038_3)Log(string.format ( "[AutoSteal] Flying to %s | Zone: %s%s | Rank: %d (Corridor Z=-360)" ,tostring(v1037_2.Category or "Egg" ),tostring(v1037_2.Area or "Field" ),v1038_3,tonumber(v1037_2.Rank )or 1 ))
                            if not h.swapped then
                                v0_95()
                            end
                            if not h.godmode then
                            ...
                            local v1038_5=v0_78(v1038_4,h.glideSpeed ,v1037_2.Uid ,v1037_1)h.glidingToTarget = false
                            if v0_104~=v1037_1 or not h.pureTweenFarm or v0_105~= "TWEEN" then
                                return
                            end
                            if not v1038_5 then
                            ...
                            if h.pureTweenFarm and(v0_105== "TWEEN" and((v1035_2.Position -v1037_2.Position )).Magnitude <= 22 )then
                                ...
                                if v1046_1 then
                                    pcall(v0_61)
                                    if h.autoGlide then
                                        h.statusText = "[AutoSteal] Secured! Tweening to Safe Line X=525..." Log( "[AutoSteal] Egg secured after Guard Strike! Returning smoothly to Safe Line X=525 along Z=-360..." )v0_80(h.glideSpeed ,v1037_1)pcall(v0_61)
                                        local v1050_1=v0_60()h.statusText =string.format ( "Stashed in Bag (%d Eggs). Next steal..." ,v1050_1)Log(string.format ( "[AutoSteal] Egg stashed in bag (%d total eggs). Hands-Free ready for next steal..." ,v1050_1))
                                    else
                                        h.statusText = "[AutoSteal] Secured! (Auto Return is OFF)" Log( "[AutoSteal] Egg secured! Staying at target (Auto Return is OFF)." )
                                    end
                                    pcall(v0_61)h.isReturning = false h.delivering = false h.glidingToTarget = false h.securingEgg = false h.currentTargetModel =nil h.targetPosition =nil
                                    if v0_75( "TWEEN" )then
                                        return
                                    end
                                else
                                    if v0_104==v1037_1 and(h.pureTweenFarm and v0_105== "TWEEN" )then
                            ...
                            if h.autoTreadmill and(not h.isBatchPlacing and not h.isHatching )then
                                if not h.onTreadmill and not v0_92()then
                                    h.statusText = "[AutoTreadmill] No targets. Mounting treadmill..." v0_89(v1037_1)
                                else
...
local v0_141=os.clock ()task.spawn (function(...)
    while h.alive do
        local v1064_1,v1064_2=pcall(function(...)
            if h.autoFarmLoop and(not h.pureTweenFarm and(v0_105== "WARP" and(not h.isBatchPlacing and(not h.teleporting and(not h.glidingToTarget and(not h.securingEgg and(not h.delivering and not h.isReturning )))))))then
                ...
                if v1066_2 and v1066_3 then
                    ...
                    if not v1067_1 then
                        ...
                        local v1068_2=v0_82()
                        if v1068_2 and(h.autoFarmLoop and(v0_105== "WARP" and v0_104==v1068_1))then
                            if h.onTreadmill or v0_92()then
                                h.statusText = "[SnipeLoop] Target found! Getting off treadmill..." v0_90()task.wait ( 0.08 )
                            end
                            local v1069_1=((v1068_2.Scale and v1068_2.Scale > 1.05 ))and string.format ( " | %.1fx" ,v1068_2.Scale )or "" Log(string.format ( "[SnipeLoop] Starting Warp Snipe: %s | Zone: %s%s (Rank %d)" ,tostring(v1068_2.Category or "Egg" ),tostring(v1068_2.Area or "Field" ),v1069_1,tonumber(v1068_2.Rank )or 1 ))h.statusText =string.format ( "[SnipeLoop] Warping for %s%s..." ,tostring(v1068_2.Category or "Egg" ),v1069_1)
                            local v1069_2=v0_84(v1068_2,v1068_1)
                            if v0_104~=v1068_1 or not h.autoFarmLoop or v0_105~= "WARP" then
                                return
                            end
                            if v1069_2 then
                                pcall(v0_61)
                                if h.autoGlide then
                                    h.statusText = "[SnipeLoop] Target secured! Tweening to Safe Line X=525..." v0_80(h.glideSpeed ,v1068_1)pcall(v0_61)
                                    local v1073_1=v0_60()h.statusText =string.format ( "Stashed in Bag (%d Eggs). Next snipe..." ,v1073_1)Log(string.format ( "[SnipeLoop] Egg stashed in bag (%d total eggs). Hands-Free ready for next snipe..." ,v1073_1))
                                else
                                ...
                                pcall(v0_61)h.isReturning = false h.delivering = false
                                if v0_75( "WARP" )then
                                    return
                                end
                            else
                                if v0_104==v1068_1 and(h.autoFarmLoop and v0_105== "WARP" )then
                            ...
                            if h.autoTreadmill and(not h.isBatchPlacing and not h.isHatching )then
                                if not h.onTreadmill and not v0_92()then
                                    h.statusText = "[AutoTreadmill] No targets. Mounting treadmill..." v0_89(v1068_1)
                                else
                                    h.statusText = "[AutoTreadmill] Running on treadmill (Waiting for eggs...)"
                                end
                            else
        ...
        local v1087_1,v1087_2=pcall(function(...)
            if h.autoTreadmill and(not h.pureTweenFarm and(not h.autoFarmLoop and(not h.isBatchPlacing and(not h.isHatching and(not h.teleporting and(not h.glidingToTarget and(not h.securingEgg and(not h.delivering and not h.isReturning ))))))))then
                ...
                if v1089_2 and not v0_62()then
                    if not h.onTreadmill and not v0_92()then
                        h.statusText = "[AutoTreadmill] Idle without farm. Mounting treadmill..." v0_89()
                    end
                end
            end
        end
...
local function v0_144(...) h.performanceMode = true pcall(function(...)
...
local function v0_145(...) h.performanceMode = false
    if v0_142 then
...
local function v0_148(...)
    ...
    v0_146= true task.spawn (function(...)
        while h and(h.alive and h.antiAFK )do
            local v1150_1= 0
            while v1150_1< 600 and(h and(h.alive and(h.antiAFK and v0_146)))do
                task.wait ( 5 )v1150_1=v1150_1+ 5
            end
            if not h.antiAFK or not v0_146 then
                break
            end
            v0_147()
        end
...
v0_3.Heartbeat :Connect(function(...)
    ...
    if v1154_3 and not((h and h.onTreadmill ))then
        if v1154_3.PlatformStand then
            v1154_3.PlatformStand = false v1154_3:ChangeState(Enum.HumanoidStateType.Running )
        end
        if v1154_3.Sit and((h.pureTweenFarm or h.autoFarmLoop or h.isReturning or h.glidingToTarget ))then
    ...
    if h.alive and(h.autoGlide and(v1154_5 and(not v0_65()and v1154_4.X >v0_41)))then
        task.spawn (function(...) v0_80(h.glideSpeed )v0_61()h.isReturning = false h.delivering = false
        end
        )
    end
end
...
local function v0_162(v1178_1,...)
    ...
    elseif h.onTreadmill or(v0_92 and v0_92())then
        return v1178_2 and "อยู่บนลู่วิ่ง" or "On Treadmill"
    elseif v0_105== "TWEEN" and not h.isReturning then
        return v1178_2 and "กำลังหาไข่" or "Searching"
    elseif v0_105== "WARP" and not h.isReturning then
        return v1178_2 and "กำลังหาไข่" or "Searching"
    else
...
local function v0_171(...) h.alive = false pcall(v0_145)pcall(v0_149)pcall(function(...) v0_3:Set3dRenderingEnabled( true )
    end
    )pcall(function(...)
...
local function v0_172(...)
    ...
    if v1281_2 then
        ...
        [ "Callback" ]=function(v1347_1,...)
            ...
            if v1347_1 then
                ...
                if v0_105== "TWEEN" or h.pureTweenFarm then
                    v0_106( "NONE" )
                end
            end
        end
        })v1289_19=v0_156.togTween v0_156.togTeleport =v0_157:Toggle({[ "Title" ]=v1289_17.Farm.TeleportTitle ;
        [ "Desc" ]=v1289_17.Farm.TeleportDesc ,[ "Icon" ]= "solar:magic-stick-3-bold" ,[ "Value" ]=h.autoFarmLoop ,[ "Callback" ]=function(v1352_1,...)
            if v1289_18 then
                return
            end
            if v1352_1 then
                ...
                if v0_105== "WARP" or h.autoFarmLoop then
                    v0_106( "NONE" )
                end
            end
        end
        ...
        [ "Callback" ]=function(...) task.spawn (function(...) v1281_3({[ "Title" ]= "Steal An Egg V1" ,[ "Content" ]=v0_155[v0_154].Notifications.PlaceStarted ,[ "Icon" ]= "loader" })h.statusText = "[Manual] Tweening to base..." v0_76(h.glideSpeed ,nil, true )v1281_3({[ "Title" ]= "Steal An Egg V1" ,[ "Content" ]=v0_155[v0_154].Notifications.PlaceDone ,[ "Icon" ]= "check-circle" })
            end
            )
        end
        ...
        [ "Callback" ]=function(v1365_1,...) h.autoPlaceEvery5 =v1365_1
            if not v1365_1 then
                h.batchStealCount = 0
            end
        ...
        [ "Value" ]=h.autoHatch ,[ "Callback" ]=function(v1367_1,...) h.autoHatch =v1367_1 v1281_3({[ "Title" ]= "Auto Hatch" ,[ "Content" ]=v1367_1 and v0_155[v0_154].Notifications.HatchStarted or v0_155[v0_154].Notifications.HatchStopped ,[ "Icon" ]=v1367_1 and "check-circle" or "x-circle" })
        end
        ...
        [ "Callback" ]=function(v1368_1,...) h.autoGlide =v1368_1 v1281_3({[ "Title" ]= "Auto Return" ;
        ...
        [ "Callback" ]=function(v1369_1,...) h.autoTreadmill =v1369_1 v0_55()v0_88()
            if not v1369_1 and((h.onTreadmill or v0_92()))then
                v0_90()
            end
        ...
        [ "Value" ]=h.autoUpgradeTreadmill ,[ "Callback" ]=function(v1371_1,...) h.autoUpgradeTreadmill =v1371_1 v0_55()
        ...
        [ "Callback" ]=function(v1372_1,...) h.autoBuyTrails =v1372_1 v0_55()
        ...
        local v1289_24={}
        for v1373_1,v1373_2 in pairs(h.selectedZones or{})do
        ...
        [ "Common" ]= "⚪ Common" }
        local v1289_28={}
        for v1387_1,v1387_2 in pairs(h.selectedRarities or{})do
        ...
        [ "Callback" ]=function(v1389_1,...)
            ...
            h.selectedRarities =v1389_2 v0_55()
        end
        ...
        [ "Max" ]= 1000 ;
        [ "Default" ]=h.glideSpeed or 600 },[ "Callback" ]=function(v1403_1,...) h.glideSpeed =v1403_1 v0_53(v1403_1)
        end
        ...
        [ "Desc" ]=string.format ( "Status: Ready\nFarm Mode: Idle\nCarried Eggs: 0\nFlight Speed: %d Studs/s" ,h.glideSpeed or 600 )})v0_156.secUI =v0_160:Section({[ "Title" ]=v1289_17.Settings.SecUI })v0_156.dropLang =v0_160:Dropdown({[ "Title" ]=v1289_17.Settings.LangTitle ,[ "Values" ]={ "English" , "ไทย" },[ "Value" ]=(v0_154== "EN" and "English" or "ไทย" ),[ "Callback" ]=function(v1404_1,...)
        ...
        [ "Desc" ]=(v1289_17.Settings and v1289_17.Settings.PerformanceDesc )or "Disables shadows, textures, particles, and shaders for maximum FPS smoothness" ,[ "Icon" ]= "solar:bolt-bold" ,[ "Value" ]=h.performanceMode ,[ "Callback" ]=function(v1409_1,...) h.performanceMode =v1409_1 v0_55()
            if v1409_1 then
                v0_144()
            else
                v0_145()
        ...
        [ "Value" ]=h.disable3D ,[ "Callback" ]=function(v1412_1,...) h.disable3D =v1412_1 v0_55()pcall(function(...) v0_3:Set3dRenderingEnabled(not v1412_1)
            end
            )
        ...
        [ "Value" ]=h.antiAFK ,[ "Callback" ]=function(v1414_1,...) h.antiAFK =v1414_1 v0_55()
            if v1414_1 then
                v0_148()
            else
                v0_149()
            ...
            while h.alive do
                pcall(function(...)
                    ...
                    if v0_156.paraLiveDash and v0_156.paraLiveDash.SetDesc then
                        ...
                        local v1431_3=string.format (v1431_2,v1423_3,v1431_1,v1423_1,h.glideSpeed or 600 )pcall(function(...) v0_156.paraLiveDash :SetDesc(v1431_3)
                        end
                        )
                    end
                end
    ...
    local v1281_34=nil
    local v1281_35=nil v1281_34=v1281_31( "Auto Steal (Tween)" , "Fly to steal eggs & auto stash into backpack" ,h.pureTweenFarm ,Color3.fromRGB ( 0 , 195 , 255 ), 11 ,function(v1448_1,...)
        if v1281_33 then
            return
        end
        if v1448_1 then
    ...
    )v1281_35=v1281_31( "Auto Steal (Teleport)" , "Teleport to steal eggs in continuous loop" ,h.autoFarmLoop ,Color3.fromRGB ( 168 , 85 , 247 ), 12 ,function(v1453_1,...)
        if v1281_33 then
            return
        end
        if v1453_1 then
    ...
    )v1281_30( "PLACE EGG" , 20 )v1281_32( "Place Egg" , "Tween home, place all carried eggs & hatch" ,Color3.fromRGB ( 16 , 215 , 130 ), 21 ,function(...) task.spawn (function(...) h.statusText = "[Manual] Depositing eggs..." v0_79(h.glideSpeed )v0_76()v0_61()h.isReturning = false h.delivering = false
        end
        )
    end
    )v1281_31( "Auto Place (Every 5)" , "Return home every 5 steals, place & wait 5s" ,h.autoPlaceEvery5 ,Color3.fromRGB ( 14 , 165 , 233 ), 22 ,function(v1472_1,...) h.autoPlaceEvery5 =v1472_1
        if not v1472_1 then
            h.batchStealCount = 0
        end
    end
    )v1281_31( "Auto Hatch" , "Automatically hatch ready eggs continuously" ,h.autoHatch ,Color3.fromRGB ( 16 , 185 , 129 ), 22 ,function(v1474_1,...) h.autoHatch =v1474_1
    end
    )v1281_31( "Auto Return" , "Automatically return to safe area after stealing" ,h.autoGlide ,Color3.fromRGB ( 245 , 158 , 11 ), 23 ,function(v1475_1,...) h.autoGlide =v1475_1
    end
    )v1281_31( "Auto Treadmill" , "Run on base treadmill when no target eggs are spawned" ,h.autoTreadmill ,Color3.fromRGB ( 168 , 85 , 247 ), 24 ,function(v1476_1,...) h.autoTreadmill =v1476_1 v0_55()v0_88()
        if not v1476_1 and((h.onTreadmill or v0_92()))then
            v0_90()
        end
    end
    ...
    (Instance.new ( "UICorner" ,v1281_40)).CornerRadius =UDim.new ( 0 , 6 )v1281_39.MouseButton1Click :Connect(function(...) h.glideSpeed =math.max ( 100 ,((h.glideSpeed or 600 ))- 25 )v1281_38.Text =string.format ( "%d Studs/s" ,h.glideSpeed )v0_53(h.glideSpeed )
    end
    )v1281_40.MouseButton1Click :Connect(function(...) h.glideSpeed =math.min ( 1000 ,((h.glideSpeed or 600 ))+ 25 )v1281_38.Text =string.format ( "%d Studs/s" ,h.glideSpeed )v0_53(h.glideSpeed )
    end
    ...
    local function v1281_42(...)
        ...
        for v1487_1,v1487_2 in ipairs(v0_38)do
            if h.selectedZones and h.selectedZones [v1487_2]then
                v1486_1=v1486_1+ 1
            end
        end
        return v1486_1
    ...
    for v1489_1,v1489_2 in ipairs(v0_38)do
        ...
        local function v1489_4(...)
            local v1490_1=h.selectedZones and h.selectedZones [v1489_2]== true
            if v1490_1 then
        ...
        v1489_4()v1489_3.MouseButton1Click :Connect(function(...)
            ...
            h.selectedZones [v1489_2]=not((h.selectedZones [v1489_2]== true ))v1489_4()v0_55()v1281_43.Text =string.format ( "📍 Target Zones (%d/12 Active)" ,v1281_42())
        end
    ...
    local function v1281_50(...)
        ...
        for v1497_1,v1497_2 in ipairs(v0_48)do
            if h.selectedRarities and h.selectedRarities [v1497_2]then
                v1496_1=v1496_1+ 1
            end
        end
        return v1496_1
    ...
    for v1499_1,v1499_2 in ipairs(v0_48)do
        ...
        local function v1499_4(...)
            local v1500_1=h.selectedRarities and h.selectedRarities [v1499_2]== true
            if v1500_1 then
        ...
        v1499_4()v1499_3.MouseButton1Click :Connect(function(...)
            ...
            h.selectedRarities [v1499_2]=not((h.selectedRarities [v1499_2]== true ))v1499_4()v0_55()v1281_52.Text =string.format ( "🥚 Target Rarities (%d/%d Active)" ,v1281_50(),#v0_48)
        end
...
Log( "[+] Initializing Dice Hub x WindUI v42.64 (Steal an Egg Edition)..." )v0_172()task.spawn (function(...) task.wait ( 0.5 )v0_95()v0_94( true )v0_86()
    if v0_10.Character then
        v0_98(v0_10.Character )
    end
    v0_61()Log( "[+] Auto Humanoid Swap & Rigid Joint Locking Active." )
end
